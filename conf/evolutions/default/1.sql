...
alter table event_user add constraint fk_event_user_user_5 foreign key (user_id) references user (id) on delete restrict on update restrict;
create index ix_event_user_user_5 on event_user (user_id);
alter table event_user add constraint fk_event_user_event_6 foreign key (event_id) references event (id) on delete restrict on update restrict;
create index ix_event_user_event_6 on event_user (event_id);
alter table place add constraint fk_place_address_7 foreign key (address_id) references address (id) on delete restrict on update restrict;
create index ix_place_address_7 on place (address_id);
...
alter table profile add constraint fk_profile_address_9 foreign key (address_id) references address (id) on delete restrict on update restrict;
create index ix_profile_address_9 on profile (address_id);
alter table role_user add constraint fk_role_user_role_10 foreign key (role_id) references role (id) on delete restrict on update restrict;
create index ix_role_user_role_10 on role_user (role_id);
alter table role_user add constraint fk_role_user_user_11 foreign key (user_id) references user (id) on delete restrict on update restrict;
create index ix_role_user_user_11 on role_user (user_id);
